...
urlpatterns = [
    ...
    url(r'^google-point-static-widget/$', PointFieldGoogleStaticWidgetView.as_view(), name="google-point-static"),
    url(r'^google-point-static-overlay-widget/$', PointFieldGoogleStaticOverlayWidgetView.as_view(), name="google-point-static-overlay"),
]
